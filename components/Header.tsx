  ...
  return (
    <div className="max-w-6xl mx-auto p-2">
      ...
      <section className="flex items-center space-x-2 py-5">
        ...
        <div className="flex items-center space-x-2 px-2 md:px-5 py-2 border-blac border-2 flex-1">
        ...
        <Link href="/create">
          <button className="border-2 border-blue-600 px-5 md:px-10 py-2 text-blue-600 hover:bg-blue-600/70 hover:text-white cursor-pointer">
            List Items
          </button>
        </Link>
      </section>
      ...
      <section className="flex py-3 space-x-6 text-xs md:text-sm whitespace-nowrap justify-center px-6">
        ...
        <p className="link hidden lg:inline">Colectibles and Art</p>
